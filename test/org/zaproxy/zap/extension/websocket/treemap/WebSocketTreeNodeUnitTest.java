...
public class WebSocketTreeNodeUnitTest {
    ...
    public void testIRemoveChild(){
        WebSocketTreeNode rootFolder_1 = new WebSocketFolderNode(WebSocketNodeType.FOLDER_ROOT,"root_1",null);
        WebSocketTreeNode rootFolder_2 = new WebSocketFolderNode(WebSocketNodeType.FOLDER_ROOT,"root_2",null);
