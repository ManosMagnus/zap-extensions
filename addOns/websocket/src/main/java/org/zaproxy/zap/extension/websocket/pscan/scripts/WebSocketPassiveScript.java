...
public interface WebSocketPassiveScript {
     ...
     *
     * @param scriptAlerts WebSocketPassiveScanAlert provide {@link
     *     WebSocketPassiveScanAlert#raiseAlert(int, int, String, String, String,
     *     WebSocketMessageDTO, String, String, String, int, int)} method so as to raise appropriate
     *     alerts
